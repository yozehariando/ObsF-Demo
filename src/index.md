...
<div class="grid grid-cols-2 gap-4 mb-4">
  ...
  <div class="card p-4">
    ...
    <div id="user-scatter-container" style="width: 100%; height: 450px; position: relative; overflow: visible;"></div>
  </div>
</div>
...
<div>
  ...
  <div class="grid" style="display: grid; grid-template-columns: 66.666% 33.333%; gap: 1rem;">
    ...
    <div class="card p-4">
      <h2 class="mb-4">Reference Map</h2>
      <div id="map-container" style="width: 100%; position: relative; overflow: hidden;"></div>
    </div>
    <!-- Details Panel - Takes 4/12 (33.333%) -->
    <div class="card p-4">
      <div class="flex justify-between items-center cursor-pointer" id="details-toggle">
        <h2 class="mb-0">Mutation Details</h2>
...
<div class="card p-4 mb-4">
  ...
  <div id="user-geo-container" style="width: 100%; height: 400px; position: relative;"></div>
</div>
